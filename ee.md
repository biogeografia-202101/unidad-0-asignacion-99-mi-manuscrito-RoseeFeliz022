...
![](ee_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
![](ee_files/figure-markdown_github/unnamed-chunk-8-1.png)
...
![](ee_files/figure-markdown_github/unnamed-chunk-10-1.png)
...
![](ee_files/figure-markdown_github/unnamed-chunk-12-1.png)
...
```
    ...
    ## D.cl.2   210.610723 376.000000   0.006464      0.412         0.412    
    ## D.cl.3   284.351204 390.000000  -0.057802      0.010         0.020 *  
    ## D.cl.4   358.091686 148.000000  -0.022590      0.146         0.292    
    ## D.cl.5   431.832168 372.000000  -0.056066      0.037         0.111    
    ## D.cl.6   505.572649 266.000000  -0.060834      0.002         0.010 ** 
...
![](ee_files/figure-markdown_github/unnamed-chunk-14-1.png)
...
```
    ...
    ## number of simulations + 1: 10000 
    ## 
    ## statistic = 0.15553, observed rank = 9845, p-value = 0.0155
    ## alternative hypothesis: greater
    ## 
    ## 
    ## $`Eugenia galalonensis`
    ...
    ## number of simulations + 1: 10000 
    ## 
    ## statistic = 0.0068478, observed rank = 6620, p-value = 0.338
    ## alternative hypothesis: greater
    ## 
    ## 
    ## $`Eugenia nesiotica`
    ...
    ## number of simulations + 1: 10000 
    ## 
    ## statistic = 0.17369, observed rank = 9901, p-value = 0.0099
    ## alternative hypothesis: greater
    ## 
    ## 
    ## $`Eugenia oerstediana`
    ...
    ## number of simulations + 1: 10000 
    ## 
    ## statistic = 0.14009, observed rank = 9764, p-value = 0.0236
    ## alternative hypothesis: greater
    ## 
    ## 
    ## $`Myrcia gatunensis`
    ...
    ## number of simulations + 1: 10000 
    ## 
    ## statistic = 0.099109, observed rank = 9425, p-value = 0.0575
    ## alternative hypothesis: greater
    ## 
    ## 
    ## $`Psidium friedrichsthalianum`
    ...
    ## number of simulations + 1: 10000 
    ## 
    ## statistic = 0.019812, observed rank = 7187, p-value = 0.2813
    ## alternative hypothesis: greater
...
![](ee_files/figure-markdown_github/unnamed-chunk-17-1.png)
...
![](ee_files/figure-markdown_github/unnamed-chunk-18-1.png)
