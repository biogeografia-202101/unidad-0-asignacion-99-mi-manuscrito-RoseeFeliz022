...
-Los tres primeros números de diversidad de Hill : *N<sub>0</sub>=q* (la riqueza de especies), *N<sub>1</sub>=exp(H)*(número de especies abundantes), y *N<sub>1</sub>=1/λ* (inverso de Simpson). 
