...
Distancia de Jacard
La similitud de Jaccard es la relación entre el número de dobles 1 y el número de especies, excluyendo las especies representadas por dobles ceros en el par de objetos
considerados. Por lo tanto, una similitud de Jaccard de 0,25 significa que el 25% del número total de especies observadas en dos sitios estaban presentes en ambos sitios y el 75% en uno solo. La disimilitud de Jaccard calculada en R es (1-0,25) o 1 0:25 p dependiendo del paquete utilizado.
