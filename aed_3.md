...
![](aed_3_files/figure-markdown_github/unnamed-chunk-4-1.png)
...
![](aed_3_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
![](aed_3_files/figure-markdown_github/unnamed-chunk-7-1.png)
...
![](aed_3_files/figure-markdown_github/unnamed-chunk-8-1.png)
...
mapa_cuadros_riq_mi_familia <- mapView(
  ...
  col.regions = rojo,
  zcol = 'riq') %>%
  addStaticLabels(label = specnumber(mc_myrtc), textsize = "12pt") %>%
  leaflet::setView(
    lng = -79.85136,
    lat = 9.15097,
    zoom = 16)
...
![](aed_3_files/figure-markdown_github/unnamed-chunk-9-1.png)
